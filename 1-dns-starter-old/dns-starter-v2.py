...
def main():
    ...
    # If the folder is empty, delete it and stop the script
    if file_count == 0:
        print(f"Directory {top_directory_path} is empty. Deleting the directory.")
        shutil.rmtree(top_directory_path)
        return
